...
@Component({
  selector: 'datosgenerales.component-dialogbuscarvario2adisa',
  templateUrl: 'datosgenerales.component-dialogbuscarvario2adisa.html',
...
export class DatosgeneralesComponentDialogBuscarVarios2aDisa implements OnInit {

  constructor(
    public dialogRef: MatDialogRef<DatosgeneralesComponentDialogBuscarVarios2aDisa>,
